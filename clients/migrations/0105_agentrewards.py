    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.IntegerField(default='', max_length=250, verbose_name='Количество выданных заявок')),
                ('procent', models.IntegerField(default='', max_length=250, verbose_name='Проценты')),
